...
export default function ProductItem({ product, onBuy, onEdit, onDelete, onDetail, userRole }) {
    ...
    return (
        <div className="productRow">
            <div className="productMain" onClick={() => onDetail(product)} style={{ cursor: 'pointer' }}>
